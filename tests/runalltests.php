...
echo getcwd();
// locate all tests
$files = glob('{./../application/*/Tests/*Test.php,./../application/*/*/Tests/*Test.php}', GLOB_BRACE);
...
while(list(, $file)=each($files)) {
    ...
    system($PHPUNIT . ' --stderr -d memory_limit=-1 -d error_reporting=E_ALL\&E_STRICT -d display_errors=0 ' . escapeshellarg($file), $c_result);
    echo PHP_EOL;
